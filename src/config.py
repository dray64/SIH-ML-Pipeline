...
RAW_DATA_PATH = DATA_DIR / "raw" / "D:\\SIH ML Pipeline\\data\\flash_flood_dataset_sensor_ready.csv"
CACHE_BUFFER_PATH = DATA_DIR / "cache" / "buffer_state.json"
MODEL_PATH = BASE_DIR / "models" / "D:\\SIH ML Pipeline\\models\\flash_flood_dual_stage_model.joblib"
